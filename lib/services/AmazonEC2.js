    ...
    quote: {
      params: {
        ...
        os: {
          ...
          info(service, { region }) {
            return `paws ${service.alias} os -r ${region}`;
          }
        },
        leaseConvertible: {
          description: 'Define if lease must be convertible',
          default: false,
          type: 'bool'
        },
        tenancy: {
      ...
      handler({ region, instanceType, lease, upfront, duration, os, leaseConvertible, tenancy, qty }) {
        ...
        details.push(...products.eval(item =>
          ...
          ,
          billing, { Hrs: duration * qty, Quantity: qty, lease, upfront, leaseConvertible }));
